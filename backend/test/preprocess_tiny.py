# Script to generate the small file problem for analysis of its impact on visualization_analysis.py
...
location_map_path = "location_map.html"
...
#%% The whole procomputation processing
def preprocess_data():
